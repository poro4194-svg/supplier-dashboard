    ...
    user.role === 'admin'
      ? [
          ...
          },
          {
            label: 'Analytics',
            icon: BarChart3,
            subItems: [{ label: 'Overview', path: '/admin/analytics' }],
          },
        ]
      : [
          {
  ...
  return (
    ...
    >
      <div className="h-16 flex items-center px-6 border-b border-gray-800">
        ...
        <span className="font-bold text-lg tracking-tight text-white">PoroGold</span>
      ...
      <nav className="p-4 space-y-6">
        <div className="px-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Main Menu</div>
